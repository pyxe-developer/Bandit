...
Stage 4 focused CodeRabbit refresh evidence for `BANDIT-056` is recorded in `docs/work/BANDIT-056/coderabbit-review.md` and `docs/specs/BANDIT-056-coderabbit-review-output.json` at source head `b31c336167918bb5a114e78a813458182e320dc9`. CodeRabbit returned seven open findings: six minor artifact/policy/template findings and one trivial cockpit-status I/O hardening finding.

The next required action is repair or explicit PM disposition of the seven focused CodeRabbit findings before Local Qwen, aggregate Stage 4 review, landing, closeout, creating another work item, or unrelated Phase 8 work.
...
- `BANDIT-056` - Evidence Freshness SLOs (active - CodeRabbit repair/disposition next)
