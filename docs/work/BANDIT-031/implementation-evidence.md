...
| Testable behavior | `pass` | Focused RED tests now pass and cover normal derivation, missing-source refusal, disagreement refusal, closed-active contradiction, source-linked summaries, and no hidden writes. |
