# CodeRabbit Formation Review - BANDIT-073
...
- gate determinism boundary preserved: not_applicable - CodeRabbit did not return a terminal review verdict.
...
```sh
timeout 600 coderabbit review --agent --base origin/main -c AGENTS.md -c CLEAN_CODE.md -c docs/verification/STAGE_RUBRICS.md -c docs/plans/BOOTSTRAP_METHODOLOGY.md
```
...
CodeRabbit formation review for `BANDIT-073` is unavailable due to provider
