...
bootstrap_gaps:
  ...
  - CLI-owned UAT artifact unavailable until Phase 5.
escalation_outcome: bootstrap_manual_evidence
final_decision: Continue GREEN implementation under TDD using focused local tests, record unavailable reviewer and landing gates as bootstrap gaps before landing, and do not ask the operator for routine routing choices.
