# CodeRabbit Formation Review - BANDIT-075
...
- replay-only reviewer calibration boundary preserved: not_applicable - CodeRabbit did not return a terminal review verdict.
...
CodeRabbit formation review for `BANDIT-075` is unavailable due to provider
