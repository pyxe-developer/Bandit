# Qwen Formation Review - BANDIT-066
...
```sh
{ <BANDIT-066 Stage 1 formation packet> } | timeout 240 qwen --bare --approval-mode plan --output-format text
```
...
Local Qwen formation review for `BANDIT-066` is unavailable in this automation
