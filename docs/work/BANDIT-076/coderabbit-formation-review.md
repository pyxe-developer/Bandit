# CodeRabbit Formation Review - BANDIT-076
...
- evidence bundle attestation boundary preserved: not_applicable - CodeRabbit did not return a terminal review verdict.
...
CodeRabbit formation review for `BANDIT-076` is unavailable due to provider
