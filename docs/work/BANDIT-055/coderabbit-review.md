...
source_head: 9fb71edd16d161d530a1b62beb10758009903867
...
resolved_or_dispositioned_findings:
  ...
  - severity: trivial
    ...
    disposition: Repaired locally by requiring either no options or exactly one --json option, with focused regression coverage in test/token-cost-failsafe.test.mjs. Two focused refresh attempts timed out after the local repair/disposition; explicit provider-refusal/bootstrap-gap replacement disposition is required before Local Qwen.
bootstrap_gaps:
  - none
