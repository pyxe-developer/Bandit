# BANDIT-094 Stage 3 MiniMax Fallback Dispatch

You are the Stage 3 Implementation Writer for `BANDIT-094`.

Claude Sonnet 4.6 was attempted first and timed out after 20 minutes without
source edits. Evidence is recorded in
...
- `docs/work/BANDIT-094/stage3-dispatch.md`
- `docs/work/BANDIT-094/stage3-claude-attempt.md`
...
posture, explicit confirmation that no Test Writer-owned surface was edited,
and the fallback reason from `stage3-claude-attempt.md`.
