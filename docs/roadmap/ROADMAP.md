...
**Current next step:** Run a focused CodeRabbit refresh for `BANDIT-056` on the locally repaired evidence artifacts before Local Qwen, aggregate Stage 4 review, landing, closeout, another work item, or unrelated Phase 8 work.
