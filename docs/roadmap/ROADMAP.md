...
**Current next step:** Run focused CodeRabbit refresh for `BANDIT-056` on the locally repaired source before Local Qwen, aggregate Stage 4 review, landing, closeout, another work item, or unrelated Phase 8 work.
