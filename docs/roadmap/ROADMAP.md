...
**Current next step:** Repair the two focused CodeRabbit findings for `BANDIT-056` before Local Qwen, aggregate Stage 4 review, landing, closeout, another work item, or unrelated Phase 8 work.
