...
**Current next step:** Create the next Phase 8 improvement chore work item for
...
recorded. The next required artifact is a structured spec and Stage 1 brief for
