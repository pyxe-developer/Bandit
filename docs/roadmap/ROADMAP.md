...
| 5 | UAT And Auto-Landing | Bandit can record UAT approval, detect stale UAT, and auto-land eligible PRs under policy. | Queued |
...
- Phase 5 CLI-owned UAT approval artifact and stale-UAT detection after
  `BANDIT-011` lands.
